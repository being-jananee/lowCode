...
export const dataTreeTypeDefCreator = (
  ...
  Object.entries(dataTree).forEach(([entityName, entity]) => {
    ...
    } else if (isBizbrainzEntity(entity)) {
      def.bizBrainz = entityDefinitions.BIZBRAINZ(entity, extraDefsToDefine);
      entityMap.set("bizBrainz", {
        type: ENTITY_TYPE.BIZBRAINZ,
        subType: ENTITY_TYPE.BIZBRAINZ,
      });
