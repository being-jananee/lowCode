...
app_path="/home/ubuntu/bizBrainz"
script_path="scripts"
...
sudo curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/aws_ami/boot.sh
sudo curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/aws_ami/first-time-setup.sh
sudo curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/aws_ami/user-data.sh
...
CRON_FILE="/etc/cron.d/bizBrainz"
