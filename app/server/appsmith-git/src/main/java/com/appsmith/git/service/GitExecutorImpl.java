package com.bizBrainz.git.service;
...
import com.bizBrainz.git.constants.BizbrainzBotAsset;
import com.bizBrainz.git.constants.CommonConstants;
import com.bizBrainz.git.constants.Constraint;
import com.bizBrainz.git.constants.GitDirectories;
import com.bizBrainz.git.helpers.RepositoryHelper;
import com.bizBrainz.git.helpers.SshTransportConfigCallback;
import com.bizBrainz.git.helpers.StopwatchHelpers;
...
public class GitExecutorImpl implements GitExecutor {
    ...
    public Mono<String> commitApplication(Path path,
        ...
        final String finalAuthorName = StringUtils.isEmptyOrNull(authorName) ? BizbrainzBotAsset.BIZBRAINZ_BOT_USERNAME : authorName;
        final String finalAuthorEmail = StringUtils.isEmptyOrNull(authorEmail) ? BizbrainzBotAsset.BIZBRAINZ_BOT_EMAIL : authorEmail;
