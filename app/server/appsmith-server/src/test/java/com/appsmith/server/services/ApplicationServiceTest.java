...
import static com.bizBrainz.server.acl.AclPermission.DELETE_PAGES;
...
import static com.bizBrainz.server.acl.AclPermission.MANAGE_THEMES;
import static com.bizBrainz.server.acl.AclPermission.PAGE_CREATE_PAGE_ACTIONS;
import static com.bizBrainz.server.acl.AclPermission.PUBLISH_APPLICATIONS;
...
import static com.bizBrainz.server.constants.FieldName.ANONYMOUS_USER;
...
import static com.bizBrainz.server.services.ApplicationPageServiceImpl.EVALUATION_VERSION;
...
public class ApplicationServiceTest {
    ...
    public void getApplicationInvalidId() {
        ...
        StepVerifier.create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.NO_RESOURCE_FOUND.getMessage(FieldName.APPLICATION, "random-id")))
                .verify();
    }
    ...
    public void getApplicationByDefaultIdAndBranchName_invalidBranchName_throwException() {
        ...
        StepVerifier.create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.NO_RESOURCE_FOUND.getMessage(FieldName.APPLICATION, gitConnectedApp.getId() + "," + "randomBranch")))
                .verify();
    }
    ...
    public void getOnlyDefaultApplicationsConnectedToGitForHome() {
        ...
        BizbrainzBeanUtils.copyNestedNonNullProperties(gitConnectedApp.getGitApplicationMetadata(), childBranchGitData);
    ...
    public void deleteUnpublishedPageFromApplication() {
        ...
        PageDTO newPage = applicationMono
                .flatMap(application -> newPageService
                        ...
                        .switchIfEmpty(Mono.error(new BizbrainzException(BizbrainzError.NO_RESOURCE_FOUND, "page")))
    ...
    public void changeDefaultPageForAPublishedApplication() {
        ...
        PageDTO newPage = applicationMono
                .flatMap(application -> newPageService
                        .findByNameAndApplicationIdAndViewMode("New Page", application.getId(), READ_PAGES, false)
                        .switchIfEmpty(Mono.error(new BizbrainzException(BizbrainzError.NO_RESOURCE_FOUND, "unpublishedEditedPage")))).block();
        ...
        Mono<Application> applicationFromDbPostViewChange = Mono.just(originalApplication)
                .flatMap(originalApp -> {
                    try {
                        ...
                        // all bizBrainz objects with public permission finishes.
                        Thread.sleep(5000);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
