...
cd template
echo $PWD
curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/template/docker-compose.yml.sh
curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/template/init-letsencrypt.sh.sh
curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/template/mongo-init.js.sh
curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/template/docker.env.sh
curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/template/nginx_app.conf.sh
curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/template/encryption.env.sh
cd ..
echo $PWD
