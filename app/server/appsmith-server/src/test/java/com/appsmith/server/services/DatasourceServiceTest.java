...
import com.bizBrainz.external.models.UploadedFile;
...
public class DatasourceServiceTest {
    ...
    public void createDatasourceWithNullWorkspaceId() {
        ...
        StepVerifier
                ...
                .assertNext(datasource1 -> {
                    ...
                    assertThat(datasource1.getInvalids()).contains(BizbrainzError.WORKSPACE_ID_NOT_GIVEN.getMessage());
                })
                .verifyComplete();
    }
    ...
    public void deleteDatasourceWithActions() {
        ...
        StepVerifier
                .create(datasourceMono)
                .verifyErrorMessage(BizbrainzError.DATASOURCE_HAS_ACTIONS.getMessage("1"));
    }
    ...
    public void testHintMessageOnLocalhostUrlOnTestDatasourceEvent() {
        ...
        StepVerifier
                ...
                .assertNext(testResult -> {
                    ...
                    String expectedMessage = "You may not be able to access your localhost if Bizbrainz is running " +
                            "inside a docker container or on the cloud. To enable access to your localhost you may use " +
                            "ngrok to expose your local endpoint to the internet. Please check out Bizbrainz's " +
        ...
        StepVerifier
                ...
                .assertNext(createdDatasource -> {
                    ...
                    String expectedMessage = "You may not be able to access your localhost if Bizbrainz is running " +
                            ...
                            "use ngrok to expose your local endpoint to the internet. Please check out Bizbrainz's " +
                            "documentation to understand more.";
                    assertThat(
        ...
        StepVerifier
                ...
                .assertNext(updatedDatasource -> {
                    ...
                    String expectedMessage = "You may not be able to access your localhost if Bizbrainz is running " +
                            ...
                            "Bizbrainz's documentation to understand more.";
                    assertThat(
                            updatedDatasource.getMessages().stream()
                                    .anyMatch(message -> expectedMessage.equals(message))
                    ).isTrue();
