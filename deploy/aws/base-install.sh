...
sudo curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/configure-ssl.sh
sudo chown ubuntu:ubuntu $boot_script_path/$config_ssl_file_name && sudo chmod +x $boot_script_path/$config_ssl_file_name

sudo curl -O https://raw.githubusercontent.com/bizBrainzorg/bizBrainz/release/deploy/aws/boot.sh
