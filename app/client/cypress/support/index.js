...
before(function() {
  ...
  cy.window().then((window) => {
    window.indexedDB.deleteDatabase("Bizbrainz");
  });
...
after(function() {
  ...
  //Commenting until Upgrade Bizbrainz cases are fixed
  // const testUrl = "http://localhost:5001/v1/parent/cmd";
  // cy.log("Start the bizBrainz container");
  // cy.StartTheContainer(testUrl, "bizBrainz"); // stop the old container
});
