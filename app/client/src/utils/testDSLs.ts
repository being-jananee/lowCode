  ...
  children: [
    {
      ...
      key: "a4gmk81297",
      labelTextSize: "0.875rem",
      backgroundColor: "{{bizBrainz.theme.colors.primaryColor}}",
      rightColumn: 64,
      widgetId: "og1bsi36p4",
      containerStyle: "card",
      isVisible: true,
          ...
          children: [
            {
                  ...
                  children: [
                    {
                      ...
                      isVisible: true,
                      fontStyle: "BOLD",
                      textColor: "{{bizBrainz.theme.colors.primaryColor}}",
                      version: 1,
                      parentId: "z05jlsrkmt",
                      renderMode: "CANVAS",
                      isLoading: false,
                  ...
                  children: [
                    {
                      template: {
                        ...
                        Container3Copy: {
                          boxShadow:
                            "{{bizBrainz.theme.boxShadow.appBoxShadow}}",
                              ...
                              children: [
                                {
                                  ...
                                  children: [
                                    ...
                                    },
                                    {
                                      ...
                                      dynamicTriggerPathList: [],
                                      fontFamily:
                                        "{{bizBrainz.theme.fontFamily.appFont}}",
                                      dynamicBindingPathList: [
                                        {
                                          key: "text",
                                        },
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      widgetId: "kug5m016a2",
                      tableData:
                        "{{getAllTimeLogs.data.filter(log=>log.task==bizBrainz.store.task || bizBrainz.store.task ==''|| bizBrainz.store.task ==undefined)}}",
                      label: "Data",
                      searchKey: "",
                      parentId: "demz6wbjrc",
                      serverSidePaginationEnabled: true,
                    ...
                    },
                    {
                      ...
                      truncateButtonColor: "#FFC13D",
                      text:
                        "{{'task' in bizBrainz.store && bizBrainz.store.task?.length>0 ? `TASK ${bizBrainz.store.task}` : 'select a bar segment to view log entries for each Task'}}",
                      key: "oqp9xeolbr",
                      isDeprecated: false,
                      rightColumn: 57,
                      textAlign: "CENTER",
                      ...
                      fontStyle: "ITALIC",
                      textColor:
                        "{{'task' in bizBrainz.store && bizBrainz.store.task?.length>0 ? 'grey' :'#ff5858'}}",
                      version: 1,
                      parentId: "demz6wbjrc",
                      renderMode: "CANVAS",
                      isLoading: false,
              ...
              widgetId: "5i1ijofu5u",
              accentColor: "{{bizBrainz.theme.colors.primaryColor}}",
              defaultTab: "{{bizBrainz.store.default_tab }}",
            ...
            },
            {
              ...
              truncateButtonColor: "#FFC13D",
              text:
                "Last Updated: {{bizBrainz.store?.updated_at || moment().format('LLL')}}",
              key: "sm2eopm278",
              labelTextSize: "0.875rem",
              rightColumn: 52,
              textAlign: "LEFT",
