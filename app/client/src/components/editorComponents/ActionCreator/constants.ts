export const BIZBRAINZ_GLOBAL_FUNCTIONS = {
...
export const BIZBRAINZ_NAMESPACED_FUNCTIONS = {
  getGeolocation: "bizBrainz.geolocation.getCurrentPosition",
  watchGeolocation: "bizBrainz.geolocation.watchPosition",
  stopWatchGeolocation: "bizBrainz.geolocation.clearWatch",
};

export const BizbrainzFunction = {
  none: "none",
  integration: "integration",
  jsFunction: "jsFunction",
  ...BIZBRAINZ_GLOBAL_FUNCTIONS,
  ...BIZBRAINZ_NAMESPACED_FUNCTIONS,
};
