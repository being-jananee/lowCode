...
/*
  For self hosted, it displays the string "Bizbrainz Community v1.10.0" or "Bizbrainz Business v1.10.0".
  For cloud hosting, it displays "Bizbrainz v1.10.0".
  This is because Bizbrainz Cloud doesn't support business features yet.
 */
export const BIZBRAINZ_DISPLAY_VERSION = (
  edition: string,
  version: string,
  cloudHosting: boolean,
) => `Bizbrainz ${!cloudHosting ? edition : ""} ${version}`;
...
export const LOGIN_PAGE_INVALID_CREDS_FORGOT_PASSWORD_LINK = () =>
  `Reset Password`;
export const NEW_TO_BIZBRAINZ = () => `New to Bizbrainz?`;
...
export const FORGOT_PASSWORD_SUCCESS_TEXT = (email: string) =>
  `A password reset link has been sent to your email address ${email} registered with Bizbrainz.`;
...
export const SERVER_API_TIMEOUT_ERROR = () =>
  `Bizbrainz server is taking too long to respond. Please try again after some time`;
...
// Todo: improve this for bizBrainz_error error message
export const REST_API_AUTHORIZATION_BIZBRAINZ_ERROR = () =>
...
export const OAUTH_AUTHORIZATION_FAILED =
  "Authorization failed. Please check your details or try again.";
// Todo: improve this for bizBrainz_error error message
export const OAUTH_AUTHORIZATION_BIZBRAINZ_ERROR = "Something went wrong.";
export const OAUTH_BIZBRAINZ_TOKEN_NOT_FOUND = "Bizbrainz token not found";
...
export const LOCAL_STORAGE_NOT_SUPPORTED_APP_MIGHT_NOT_WORK_AS_EXPECTED = () =>
  "LocalStorage is not supported on your device. Some features including the Bizbrainz store won't work.";
...
export const DEBUGGER_INTERCOM_TEXT = (text: string) =>
  `Hi, \nI'm facing the following error on Bizbrainz, can you please help? \n\n${text}`;
...
export const DEBUGGER_BIZBRAINZ_SUPPORT = () => "Get Bizbrainz support";
...
export const CHANGES_ONLY_MIGRATION = () =>
  "Bizbrainz update changes since last commit";
export const CHANGES_USER_AND_MIGRATION = () =>
  "Bizbrainz update and user changes since last commit";
export const CURRENT_PAGE_DISCARD_WARNING = (page: string) =>
  `Current page (${page}) is in the discard list.`;
// GIT DEPLOY end

// GIT CHANGE LIST begin
export const CHANGES_FROM_BIZBRAINZ = () =>
  "Some changes are platform upgrades from Bizbrainz.";
...
export const DOC_DESCRIPTION = () =>
  `Find answers through Bizbrainz documentation.`;
...
export const ONBOARDING_CHECKLIST_BANNER_HEADER = () =>
  "Amazing work! You’ve explored the basics of Bizbrainz";
...
export const ONBOARDING_CHECKLIST_HEADER = () => "👋 Welcome to Bizbrainz!";
export const ONBOARDING_CHECKLIST_BODY = () =>
  "Let’s get you started on your first application, explore Bizbrainz yourself or follow our guide below to discover what Bizbrainz can do.";
...
//Introduction modal
export const HOW_BIZBRAINZ_WORKS = () =>
  "Here’s a quick overview of how Bizbrainz works. ";
...
export const WELCOME_TO_BIZBRAINZ = () => "Welcome to Bizbrainz!";
export const QUERY_YOUR_DATABASE = () =>
  "Query your own database or API inside Bizbrainz. Write JS to construct dynamic queries.";
...
export const WELCOME_FORM_DATA_COLLECTION_LABEL_ENABLE = () =>
  "Share data & make Bizbrainz better!";
...
export const SHARE_BUTTON_TOOLTIP = () => "Invite your team to Bizbrainz";
...
export const INFO_VERSION_MISMATCH_FOUND_RELOAD_REQUEST = () =>
  "Hey! There is a new version of Bizbrainz available. Please consider refreshing your window.";
...
export const WELCOME_FORM_NON_SUPER_USER_USE_CASE = () =>
  "What are you planning to use Bizbrainz for?";
...
export const RATING_TITLE = () =>
  "Congratulations! You just built your first app in Bizbrainz.";
...
export const CLEAN_URL_UPDATE = {
  ...
  disclaimer: () =>
    "Existing references to <strong>bizBrainz.URL.fullpath</strong> and <strong>bizBrainz.URL.pathname</strong> properties will behave differently.",
};
