...
export const HelpPopoverStyle = createGlobalStyle`
  .bp3-portal {
    .delete-menu-item {
      .cs-icon, .cs-text {
        color: var(--bizBrainz-color-red-500) !important;
        svg {
          path {
            fill: var(--bizBrainz-color-red-500) !important;
          }
        }
      }
    }
...
export const StyledSearchInput = styled(SearchInput)`
  > div {
    border-radius: 1px;
    border: 1px solid var(--bizBrainz-color-black-250);
    color: var(--bizBrainz-color-black-700);
    box-shadow: none;
    margin: 0 16px 0 0;
...
export const StickyHeader = styled.div`
  position: sticky;
  top: 0;
  background: var(--bizBrainz-color-black-0);
  padding-bottom: 8px;
  z-index: 4;
`;
