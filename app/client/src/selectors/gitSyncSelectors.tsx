...
const FALLBACK_GIT_SYNC_DOCS_URL =
  "https://docs.bizBrainz.com/advanced-concepts/version-control-with-git";
...
export const getDisconnectDocUrl = () =>
  "https://docs.bizBrainz.com/advanced-concepts/version-control-with-git/disconnect-the-git-repository";
