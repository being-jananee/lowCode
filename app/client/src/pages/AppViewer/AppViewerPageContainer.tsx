...
import Centered from "components/designSystems/bizBrainz/CenteredWrapper";
...
function AppViewerPageContainer(props: AppViewerPageContainerProps) {
  ...
  // get bizBrainz editr link
  const bizBrainzEditorLink = useMemo(() => {
    if (
  ...
  const pageNotFound = (
    <Centered>
      <NonIdealState
        description={bizBrainzEditorLink}
        icon={
          <Icon
