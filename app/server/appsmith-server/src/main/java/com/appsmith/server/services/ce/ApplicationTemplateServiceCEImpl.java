...
import com.bizBrainz.server.dtos.ApplicationTemplate;
...
public class ApplicationTemplateServiceCEImpl implements ApplicationTemplateServiceCE {
        ...
        return WebClientUtils
                ...
                .exchangeToFlux(clientResponse -> {
                    if (clientResponse.statusCode().equals(HttpStatus.OK)) {
                        ...
                        return Flux.error(new BizbrainzException(BizbrainzError.CLOUD_SERVICES_ERROR, clientResponse.statusCode()));
                    } else {
        ...
        return WebClientUtils
                ...
                .exchangeToMono(clientResponse -> {
                    if (clientResponse.statusCode().equals(HttpStatus.OK)) {
                        ...
                        return Mono.error(new BizbrainzException(BizbrainzError.CLOUD_SERVICES_ERROR, clientResponse.statusCode()));
                    } else {
    ...
    private Mono<ApplicationJson> getApplicationJsonFromTemplate(String templateId) {
        ...
        return webClient
                ...
                .switchIfEmpty(
                        Mono.error(new BizbrainzException(BizbrainzError.NO_RESOURCE_FOUND, "template", templateId))
                );
    }
