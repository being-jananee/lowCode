...
public class NewActionServiceCEImplTest {
    ...
    public void testExecuteAction_withoutExecuteActionDTOPart_failsValidation() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(e -> e instanceof BizbrainzException &&
                        e.getMessage().equals(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.ACTION_ID)))
                .verify();
    }
    ...
    public void testExecuteAction_withMalformedExecuteActionDTO_failsValidation() {
        ...
        StepVerifier
                .create(actionExecutionResultMono)
                .expectErrorMatches(e -> e instanceof BizbrainzException &&
                        e.getMessage().equals(BizbrainzError.INVALID_PARAMETER.getMessage("executeActionDTO")))
                .verify();
    }
