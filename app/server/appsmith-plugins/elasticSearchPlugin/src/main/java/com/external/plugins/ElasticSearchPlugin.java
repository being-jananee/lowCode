        ...
        public Mono<ActionExecutionResult> execute(RestClient client,
            ...
            return Mono.fromCallable(() -> {
                        ...
                        if (isBulkQuery(path)) {
                            ...
                            if (body != null && body.trim().startsWith("[")) {
                                ...
                                try {
                                    ...
                                    log.warn(message, e);
                                    return Mono.error(new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR, message));
                                }
                        ...
                        try {
                            ...
                            log.warn(message, e);
                            return Mono.error(new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_ERROR, message));
                        }
