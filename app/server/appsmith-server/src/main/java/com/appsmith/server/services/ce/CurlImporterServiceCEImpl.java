...
public class CurlImporterServiceCEImpl extends BaseApiImporter implements CurlImporterServiceCE {
    ...
    public Mono<ActionDTO> importAction(Object input, String pageId, String name, String workspaceId, String branchName) {
        ...
        try {
            if (input == null) {
                throw new BizbrainzException(BizbrainzError.INVALID_PARAMETER, FieldName.CURL_CODE);
            }
        ...
        if (action == null) {
            return Mono.error(new BizbrainzException(BizbrainzError.INVALID_CURL_COMMAND));
        }
    ...
    public ActionDTO curlToAction(String command, String name) throws BizbrainzException {
    ...
    public ActionDTO curlToAction(String command) throws BizbrainzException {
    ...
    public List<String> lex(String text) {
        ...
        for (int i = 0; i < textLength; ++i) {
            ...
            if (isDollarSubshellPossible) {
                if (currentChar == '(') {
                    throw new BizbrainzException(BizbrainzError.GENERIC_BAD_REQUEST, "Please do not try to invoke a subshell in the cURL");
                }
            }
    ...
    public ActionDTO parse(List<String> tokens) throws BizbrainzException {
        ...
        for (int i = 1; i < tokens.size(); ++i) {
            ...
            if (ARG_REQUEST.equals(state)) {
                ...
                if (method == null) {
                    throw new BizbrainzException(BizbrainzError.INVALID_CURL_METHOD, token);
                }
                ...
                if (parts.length != 2) {
                    throw new BizbrainzException(BizbrainzError.INVALID_CURL_HEADER, token);
                }
