...
import static com.bizBrainz.external.helpers.PluginUtils.getValueSafelyFromFormData;
...
public class GraphQLPaginationUtils {
    ...
    public static Map getPaginationData(ActionConfiguration actionConfiguration) throws BizbrainzPluginException {
    ...
    public static void updateVariablesWithPaginationValues(ActionConfiguration actionConfiguration,
                                                           ExecuteActionDTO executeActionDTO) throws BizbrainzPluginException {
        ...
        if (isEmpty(paginationDataMap)) {
            throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR, "Bizbrainz " +
        ...
        if (PaginationType.PAGE_NO.equals(actionConfiguration.getPaginationType())) {
            ...
            try {
                ...
                throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR, "Please provide " +
            ...
            throw new BizbrainzPluginException(
                    ...
                    "Bizbrainz server encountered an unexpected error: unrecognized pagination type: " + actionConfiguration.getPaginationType() +
