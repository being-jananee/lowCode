...
Widget code resides in the `src/widgets` folder of the Bizbrainz codebase. Each widget has its own folder. As shown in the screenshot above, widget folders contain the following files and folders -
