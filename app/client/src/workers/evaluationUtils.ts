...
import { Severity } from "entities/BizbrainzConsole";
...
export function isBizbrainzEntity(
  entity: DataTreeEntity,
): entity is DataTreeBizbrainz {
  return (
    typeof entity === "object" &&
    "ENTITY_TYPE" in entity &&
    entity.ENTITY_TYPE === ENTITY_TYPE.BIZBRAINZ
  );
}
...
// Check issue https://github.com/bizBrainzorg/bizBrainz/issues/719
