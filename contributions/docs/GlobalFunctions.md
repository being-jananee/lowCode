Global functions in Bizbrainz are available through the right-hand pane and in the JS editor. They allow users to perform different tasks throughout the Bizbrainz application.
