    ...
    public Document parseCommand() {
        ...
        if (dataType.equals(DataType.ARRAY)) {
            try {
                ...
                throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR, "Array of Pipelines could not be parsed into expected Mongo BSON Array format.");
            }
        } else {
            ...
            if (jsonObject.charAt(jsonObject.length() - 1) != '}') {
                throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR, "Pipeline stage is not a valid JSON object.");
            }
