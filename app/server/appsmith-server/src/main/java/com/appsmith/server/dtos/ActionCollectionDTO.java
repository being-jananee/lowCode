...
//    ActionDTO defaultAction;
    ...
    public Set<String> validate() {
        ...
        if (this.workspaceId == null) {
            validationErrors.add(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.WORKSPACE_ID));
        }
        if (this.applicationId == null) {
            validationErrors.add(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.APPLICATION_ID));
        }
        if (this.pageId == null) {
            validationErrors.add(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.PAGE_ID));
        }
        if (this.pluginId == null) {
            validationErrors.add(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.PLUGIN_ID));
        }
        if (this.pluginType == null) {
            validationErrors.add(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.PLUGIN_TYPE));
        }
