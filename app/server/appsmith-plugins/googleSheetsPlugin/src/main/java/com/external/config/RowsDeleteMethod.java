...
public class RowsDeleteMethod implements ExecutionMethod, TemplateMethod {
    ...
    public boolean validateExecutionMethodRequest(MethodConfig methodConfig) {
        ...
        if (methodConfig.getRowIndex() == null || methodConfig.getRowIndex().isBlank()) {
            throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR, "Missing required field Row index");
        }
        int rowIndex = 0;
        try {
        ...
        return client.method(HttpMethod.GET)
                ...
                .map(response -> {// Choose body depending on response status
                    ...
                    try {
                        ...
                        Mono.error(new BizbrainzPluginException(
                    ...
                    if (sheetId == null) {
                        throw Exceptions.propagate(new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_ERROR, "Unknown Sheet Name"));
                    } else {
