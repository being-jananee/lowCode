...
@Component
@Order(-2)
public class BizbrainzErrorWebExceptionHandler extends DefaultErrorWebExceptionHandler {
    @Autowired
    public BizbrainzErrorWebExceptionHandler(ErrorAttributes errorAttributes, WebProperties webProperties,
