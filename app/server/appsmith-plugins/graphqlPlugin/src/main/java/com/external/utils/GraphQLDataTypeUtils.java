...
import static com.bizBrainz.external.helpers.DataTypeStringUtils.placeholderPattern;
...
public class GraphQLDataTypeUtils {
    ...
    public static GraphQLBodyDataType stringToKnownGraphQLDataTypeConverter(String queryBody, String replacement) {
        ...
        String prefix = queryBody.split(BIZBRAINZ_SUBSTITUTION_PLACEHOLDER)[0].trim();
