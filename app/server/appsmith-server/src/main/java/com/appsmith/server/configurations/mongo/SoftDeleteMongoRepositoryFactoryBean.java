package com.bizBrainz.server.configurations.mongo;
...
/**
 * This factory bean class is set in the annotation @EnableReactiveMongoRepositories in {@link com.bizBrainz.server.configurations.CommonConfig}
