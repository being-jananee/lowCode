import { EXECUTION_PARAM_KEY } from "constants/BizbrainzActionConstants/ActionConstants";
 ...
 * These identifiers are already present in the worker context and shouldn't represent any valid identifier within Bizbrainz, as no entity should have
...
export const DEDICATED_WORKER_GLOBAL_SCOPE_IDENTIFIERS = {
  ...
  // Identifiers added to worker scope by Bizbrainz
