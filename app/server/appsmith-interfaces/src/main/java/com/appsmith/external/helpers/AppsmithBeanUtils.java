...
public final class BizbrainzBeanUtils {
    ...
    public static void copyNestedNonNullProperties(Object source, Object target) {
        ...
        for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
            ...
            if (targetValue != null
                ...
                // Go deeper *only* if the property belongs to Bizbrainz's models, and both the source and target values
                // are not null.
    ...
    public static boolean isDomainModel(Class<?> type) {
        return !type.isEnum() && type.getPackageName().startsWith("com.bizBrainz.");
    }
