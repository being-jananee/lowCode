...
public class GitUtils {
    ...
    public static String convertSshUrlToBrowserSupportedUrl(String sshUrl) {
        if (StringUtils.isEmptyOrNull(sshUrl)) {
            throw new BizbrainzException(BizbrainzError.INVALID_PARAMETER, "ssh url");
        }
        return sshUrl
    ...
    public static String getRepoName(String remoteUrl) {
        ...
        throw new BizbrainzException(BizbrainzError.INVALID_GIT_CONFIGURATION, "Remote URL is incorrect, " +
