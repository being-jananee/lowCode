...
describe("Text Widget color/font/alignment Functionality", function() {
  ...
  it("Test to validate parsing link", function() {
    ...
    cy.testCodeMirror("https://app.bizBrainz.com");
    // check if it's parsed as link
    cy.get(commonlocators.headingTextStyle);
    cy.contains("a", "https://app.bizBrainz.com").should(
      "have.attr",
      "href",
      "https://app.bizBrainz.com",
    );
    ...
    cy.contains("a", "https://app.bizBrainz.com").should("not.exist");
