...
import com.bizBrainz.external.git.FileInterface;
import com.bizBrainz.external.helpers.Stopwatch;
import com.bizBrainz.external.models.ApplicationGitReference;
import com.bizBrainz.external.models.Datasource;
import com.bizBrainz.git.helpers.FileUtilsImpl;
...
import static com.bizBrainz.external.helpers.BizbrainzBeanUtils.copyProperties;
import static com.bizBrainz.server.constants.FieldName.ACTION_COLLECTION_LIST;
import static com.bizBrainz.server.constants.FieldName.ACTION_LIST;
import static com.bizBrainz.server.constants.FieldName.DATASOURCE_LIST;
import static com.bizBrainz.server.constants.FieldName.DECRYPTED_FIELDS;
import static com.bizBrainz.server.constants.FieldName.EDIT_MODE_THEME;
import static com.bizBrainz.server.constants.FieldName.EXPORTED_APPLICATION;
import static com.bizBrainz.server.constants.FieldName.PAGE_LIST;
...
public class GitFileUtils {
    ...
    public Mono<Path> saveApplicationToLocalRepo(Path baseRepoSuffix,
        ...
        /*
            ...
            2. Create application reference for bizBrainz-git module
    ...
    /**
     * Method to convert application resources to the structure which can be serialised by bizBrainz-git module for
     * serialisation
     ...
     * Link to bizBrainz documentation for Git related operations
     * Welcome message
     *
    ...
    public Mono<Path> initializeReadme(Path baseRepoSuffix,
        ...
        return fileUtils.initializeReadme(baseRepoSuffix,viewModeUrl, editModeUrl)
                .onErrorResume(e -> Mono.error(new BizbrainzException(BizbrainzError.GIT_FILE_SYSTEM_ERROR, e)));
    }
