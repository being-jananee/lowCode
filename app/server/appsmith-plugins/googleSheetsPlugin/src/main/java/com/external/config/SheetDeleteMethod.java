...
public class SheetDeleteMethod implements ExecutionMethod {
    ...
    public boolean validateExecutionMethodRequest(MethodConfig methodConfig) {
        if (methodConfig.getSpreadsheetId() == null || methodConfig.getSpreadsheetId().isBlank()) {
            throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_ERROR, "Missing required field Spreadsheet Url");
        }
        if (methodConfig.getSheetName() == null || methodConfig.getSheetName().isBlank()) {
            throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_ERROR, "Missing required field Sheet Name");
        }
