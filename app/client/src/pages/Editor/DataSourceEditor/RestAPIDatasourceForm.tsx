...
import { createNewApiName } from "utils/BizbrainzUtils";
import { DATASOURCE_REST_API_FORM } from "@bizBrainz/constants/forms";
...
import CenteredWrapper from "components/designSystems/bizBrainz/CenteredWrapper";
...
import { ReduxAction } from "@bizBrainz/constants/ReduxActionConstants";
import {
...
import CopyToClipBoard from "components/designSystems/bizBrainz/CopyToClipBoard";
import { BaseButton } from "components/designSystems/bizBrainz/BaseButton";
      ...
      <>
        ...
        <FormInputContainer data-replay-id={btoa("isSendSessionEnabled")}>
          {this.renderDropdownControlViaFormControl(
            ...
            "Send Bizbrainz signature header",
            "",
            true,
            "Header key: X-BIZBRAINZ-SIGNATURE",
          )}
        </FormInputContainer>
