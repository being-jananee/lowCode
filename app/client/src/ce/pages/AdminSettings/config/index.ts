...
import { config as GeneralConfig } from "@bizBrainz/pages/AdminSettings/config/general";
...
import { config as Authentication } from "@bizBrainz/pages/AdminSettings/config/authentication";
