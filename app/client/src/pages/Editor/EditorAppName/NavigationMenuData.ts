      ...
      children: [
        {
          ...
          onClick: () => openExternalLink("https://community.bizBrainz.com/"),
          type: MenuTypes.MENU,
          isVisible: true,
          isOpensNewWindow: true,
        },
        ...
        },
        {
          text: "Github",
          onClick: () =>
            openExternalLink("https://github.com/bizBrainzorg/bizBrainz/"),
          type: MenuTypes.MENU,
          isVisible: true,
          isOpensNewWindow: true,
        },
        {
          text: "Documentation",
          onClick: () => openExternalLink("https://docs.bizBrainz.com/"),
          type: MenuTypes.MENU,
          isVisible: true,
          isOpensNewWindow: true,
        },
