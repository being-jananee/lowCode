...
import { Page } from "@bizBrainz/constants/ReduxActionConstants";
...
export interface DataTreeBizbrainz extends Omit<AppDataState, "store"> {
  ENTITY_TYPE: ENTITY_TYPE.BIZBRAINZ;
...
export class DataTreeFactory {
  static create({
    ...
    dataTree.bizBrainz = {
      ...
      theme,
    } as DataTreeBizbrainz;
    (dataTree.bizBrainz as DataTreeBizbrainz).ENTITY_TYPE = ENTITY_TYPE.BIZBRAINZ;
