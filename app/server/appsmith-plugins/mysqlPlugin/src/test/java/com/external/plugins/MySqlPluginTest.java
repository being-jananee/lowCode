...
public class MySqlPluginTest {
        ...
        private static DatasourceConfiguration createDatasourceConfiguration() {
                ...
                /* set ssl mode */
                datasourceConfiguration.setConnection(new com.bizBrainz.external.models.Connection());
        ...
        public DatasourceConfiguration createDatasourceConfigForContainerWithInvalidTZ() {
                ...
                dsConfig.setConnection(new com.bizBrainz.external.models.Connection());
                dsConfig.getConnection().setMode(com.bizBrainz.external.models.Connection.Mode.READ_WRITE);
        ...
        public void testPreparedStatementErrorWithIsKeyword() {
                ...
                StepVerifier.create(executeMono)
                                .verifyErrorSatisfies(error -> {
                                        ...
                                        String expectedMessage = "Bizbrainz currently does not support the IS keyword with the prepared "
                                                        +
         ...
         */
        @Test
        public void testExecuteDataTypesExtensive() throws BizbrainzPluginException {
        ...
        public void testNullObjectWithPreparedStatement() {
                ...
                actionConfiguration.setBody("SELECT * from (\n" +
                                "\tselect 'Bizbrainz' as company_name, true as open_source\n" +
                                "\tunion\n" +
