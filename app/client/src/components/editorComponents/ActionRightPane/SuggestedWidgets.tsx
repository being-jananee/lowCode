...
export const WIDGET_DATA_FIELD_MAP: Record<string, WidgetBindingInfo> = {
  LIST_WIDGET: {
    ...
    widgetName: "List",
    image: "https://assets.bizBrainz.com/widgetSuggestion/list.svg",
  },
  TABLE_WIDGET: {
    label: "tabledata",
    propertyName: "tableData",
    widgetName: "Table",
    image: "https://assets.bizBrainz.com/widgetSuggestion/table.svg",
  },
  TABLE_WIDGET_V2: {
    label: "tabledata",
    propertyName: "tableData",
  ...
  CHART_WIDGET: {
    ...
    widgetName: "Chart",
    image: "https://assets.bizBrainz.com/widgetSuggestion/chart.svg",
  },
  SELECT_WIDGET: {
    label: "options",
    propertyName: "options",
    widgetName: "Select",
    image: "https://assets.bizBrainz.com/widgetSuggestion/dropdown.svg",
  },
  TEXT_WIDGET: {
    label: "text",
    propertyName: "text",
    widgetName: "Text",
    image: "https://assets.bizBrainz.com/widgetSuggestion/text.svg",
  },
  INPUT_WIDGET_V2: {
    label: "text",
    propertyName: "defaultText",
    widgetName: "Input",
    image: "https://assets.bizBrainz.com/widgetSuggestion/input.svg",
  },
};
