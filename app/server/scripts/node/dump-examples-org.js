...
function findExamplesJsonPath() {
	...
	while (projectDir !== null && !fs.existsSync(path.join(projectDir, "bizBrainz-server"))) {
		projectDir = path.dirname(projectDir);
	}

	return path.join(projectDir, "bizBrainz-server", "src", "main", "resources", "examples-organization.json");
}
