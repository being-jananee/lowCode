...
import com.bizBrainz.server.domains.ApplicationPage;
...
import com.bizBrainz.server.helpers.MockPluginExecutor;
import com.bizBrainz.server.helpers.PluginExecutorHelper;
import com.bizBrainz.server.migrations.JsonSchemaMigration;
...
import static com.bizBrainz.server.constants.FieldName.DEFAULT_PAGE_LAYOUT;
...
public class GitServiceTest {
    ...
    public void connectApplicationToGit_EmptyRemoteUrl_ThrowInvalidParameterException() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_PARAMETER.getMessage("Remote Url")))
                .verify();
    }
    ...
    public void connectApplicationToGit_EmptyOriginHeader_ThrowInvalidParameterException() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_PARAMETER.getMessage("origin")))
                .verify();
    }
    ...
    public void connectApplicationToGit_InvalidGitApplicationMetadata_ThrowInvalidGitConfigurationException() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> {
                    assertThat(throwable instanceof BizbrainzException).isTrue();
                    assertThat(throwable.getMessage())
                            .contains(BizbrainzError.INVALID_GIT_SSH_CONFIGURATION.getMessage("origin"));
                    assertThat(((BizbrainzException) throwable).getReferenceDoc()).isNotEmpty();
                    return true;
                })
                .verify();
    }
    ...
    public void connectApplicationToGit_EmptyPrivateKey_ThrowInvalidGitConfigurationException() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_GIT_SSH_CONFIGURATION.getMessage("origin")))
                .verify();
    }
    ...
    public void connectApplicationToGit_InvalidRemoteUrlHttp_ThrowInvalidRemoteUrl() throws ClassCastException {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException && throwable.getMessage().equals(BizbrainzError.INVALID_GIT_SSH_URL.getMessage()))
                .verify();
    }
    ...
    public void connectApplicationToGit_ClonedRepoNotEmpty_Failure() throws IOException {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_GIT_REPO.getMessage()))
                .verify();
    }
    ...
    public void connectApplicationToGit_cloneException_throwGitException() throws IOException {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().equals(BizbrainzError.GIT_GENERIC_ERROR.getMessage("error message")))
                .verify();
    }
    ...
    public void connectApplicationToGit_WithoutGitProfileUsingLocalProfile_ThrowAuthorNameUnavailableError() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_PARAMETER.getMessage("Author Name")))
                .verify();
    }
    ...
    public void connectApplicationToGit_moreThanThreePrivateRepos_throwException() throws IOException, GitAPIException {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(error -> error instanceof BizbrainzException
                        && error.getMessage().equals(BizbrainzError.GIT_APPLICATION_LIMIT_ERROR.getMessage()))
                .verify();
    }
    ...
    public void detachRemote_EmptyGitData_NoChange() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException & throwable.getMessage().contains("Git configuration is invalid"))
                .verify();
    }
    ...
    public void listBranchForApplication_emptyGitMetadata_throwError() {
        ...
        StepVerifier
                .create(listMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.INVALID_GIT_CONFIGURATION.getMessage(GIT_CONFIG_ERROR)))
                .verify();
    }
    ...
    public void isBranchMergeable_checkMergingWithRemoteBranch_throwsUnsupportedOperationException() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException && throwable.getMessage().contains("origin/branch2"))
                .verify();
    ...
    public void checkoutRemoteBranch_presentInLocal_throwError() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().equals(BizbrainzError.GIT_ACTION_FAILED.getMessage("checkout", "origin/branchInLocal already exists in local - branchInLocal")))
                .verify();
    }
    ...
    public void checkoutBranch_branchNotProvided_throwInvalidParameterError() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().equals(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.BRANCH_NAME)))
                .verify();
    }
    ...
    public void commitApplication_applicationNotConnectedToGit_throwInvalidGitConfigException() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        ...
                        BizbrainzError.INVALID_GIT_CONFIGURATION.getMessage(GIT_CONFIG_ERROR))
                )
                .verify();
    }
    ...
    public void commitApplication_localRepoNotAvailable_throwRepoNotFoundException() throws GitAPIException, IOException {
        ...
        Mockito.when(gitFileUtils.saveApplicationToLocalRepo(Mockito.any(Path.class), Mockito.any(ApplicationJson.class), Mockito.anyString()))
                .thenReturn(Mono.error(new RepositoryNotFoundException(BizbrainzError.REPOSITORY_NOT_FOUND.getMessage())));

        StepVerifier
                .create(commitMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.REPOSITORY_NOT_FOUND.getMessage(gitConnectedApplication.getId())))
                .verify();
    }
    ...
    public void commitApplication_pushFails_verifyAppNotPublished_throwUpstreamChangesFoundException() throws GitAPIException, IOException {
        ...
        Mockito.when(gitExecutor.pushApplication(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any()))
                .thenReturn(Mono.error(new BizbrainzException(BizbrainzError.GIT_UPSTREAM_CHANGES)));

        StepVerifier
                .create(commitMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals((new BizbrainzException(BizbrainzError.GIT_ACTION_FAILED, "push", BizbrainzError.GIT_UPSTREAM_CHANGES.getMessage())).getMessage()))
                .verify();
    ...
    public void createBranch_branchWithOriginPrefix_throwUnsupportedException() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException && throwable.getMessage()
                        .contains(BizbrainzError.INVALID_PARAMETER.getMessage(FieldName.BRANCH_NAME)))
                .verify();
    }
    ...
    public void createBranch_duplicateNameBranchPresentInRemote_throwDuplicateKeyException() {
        ...
        StepVerifier
                .create(createBranchMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException && throwable.getMessage()
                        .contains(BizbrainzError.DUPLICATE_KEY_USER_ERROR.getMessage("remotes/origin/" + createGitBranchDTO.getBranchName(), FieldName.BRANCH_NAME)))
                .verify();
    }
    ...
    public void generateSSHKeyDefaultType_DataNotExistsInCollection_Success() {
        ...
        StepVerifier
                ...
                .assertNext(s -> {
                    ...
                    assertThat(s.getPublicKey()).contains("bizBrainz");
    ...
    public void importApplicationFromGit_emptyWorkspaceId_ThrowError() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_PARAMETER.getMessage("Invalid workspace id")))
                .verify();
    }
    ...
    public void importApplicationFromGit_privateRepoLimitReached_ThrowApplicationLimitError() {
        ...
        StepVerifier
                .create(applicationMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.GIT_APPLICATION_LIMIT_ERROR.getMessage(BizbrainzError.GIT_APPLICATION_LIMIT_ERROR.getMessage())))
                .verify();
    }
