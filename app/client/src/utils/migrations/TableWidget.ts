 ...
 * https://github.com/bizBrainzorg/bizBrainz/issues/6897
 */
    ...
    if (child.type === "TABLE_WIDGET") {
      ...
      if (primaryColumnEntries.length) {
        for (const [, primaryColumnEntry] of primaryColumnEntries.entries()) {
          // Value is reassigned when its invalid(Faulty DSL  https://github.com/bizBrainzorg/bizBrainz/issues/8979)
