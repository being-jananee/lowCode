...
public class EmailConfig {
    ...
    private static final String DEFAULT_MAIL_FROM = "bizBrainz@localhost";
    ...
    public void setMailFrom(@Value("${mail.from}") String value) {
        ...
        try {
            mailFrom = new InternetAddress(value, "Bizbrainz");
        } catch (UnsupportedEncodingException e) {
            log.error("Encoding error creating Bizbrainz mail from address. Using default from address instead.", e);
            try {
                mailFrom = new InternetAddress(DEFAULT_MAIL_FROM, "Bizbrainz");
