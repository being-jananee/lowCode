...
let res = [
    db.organization.insert({
        ...
        "deleted": false,
        "_class": "com.bizBrainz.server.domains.Organization",
        "plugins": [
            {
    ...
    db.group.insert({
            ...
            "deleted": false,
            "_class": "com.bizBrainz.server.domains.Group"
        },
        {
    ...
    db.user.insert({
        ...
        "_class": "com.bizBrainz.server.domains.User",
        "permissions": [
            "create:organizations"
        ],
    ...
    db.application.insert({
        ...
        "organizationId": "5da151714a020300041ae8fd",
        "deleted": false,
        "_class": "com.bizBrainz.server.domains.Application"
    }),
    ...
    db.page.insert({
            ...
            "deleted": false,
            "_class": "com.bizBrainz.server.domains.Page"
        }
    ),
    ...
    db.config.insert({
        ...
        "deleted": false,
        "_class": "com.bizBrainz.server.domains.PropertyPane"
    })
