  ...
  it("works properly", () => {
    const cases: Array<{
      ...
      },
      {
        ...
        script: "Table9.data[bizBrainz.store.row]",
        expectedResults: ["Table9.data", "bizBrainz.store.row"],
      },
      {
      ...
      // "bizBrainz" is an internal identifier and should be a valid reference
      {
        script: `function(){
          return bizBrainz.user
        }()`,
        expectedResults: ["bizBrainz.user"],
      },
    ];
