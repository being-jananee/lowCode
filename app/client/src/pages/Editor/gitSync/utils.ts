import { ApplicationPayload } from "@bizBrainz/constants/ReduxActionConstants";
import {
...
export const GIT_DOC_URLs = {
  base: "https://docs.bizBrainz.com/advanced-concepts/version-control-with-git",
  import:
    "https://docs.bizBrainz.com/advanced-concepts/version-control-with-git/import-from-repository",
  connect:
    "https://docs.bizBrainz.com/advanced-concepts/version-control-with-git/connecting-to-git-repository",
};
