...
} from "@bizBrainz/pages/workspace/helpers";
import { INVITE_USERS_TO_WORKSPACE_FORM } from "@bizBrainz/constants/forms";
import {
  createMessage,
...
import { getInitialsAndColorCode } from "utils/BizbrainzUtils";
...
export const { mailEnabled } = getBizbrainzConfigs();
          ...
          <>
            {!mailEnabled && !disableEmailSetup && (
              <MailConfigContainer>
                ...
                <a
                  href="https://docs.bizBrainz.com/v/v1.2.1/setup/docker/email"
