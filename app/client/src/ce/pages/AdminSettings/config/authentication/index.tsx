...
const FormAuth: AdminConfigType = {
  ...
  title: "Form Login",
  subText: "Enable your workspace to sign in with Bizbrainz Form.",
  canSave: true,
  isConnected: false,
  settings: [
    {
      id: "BIZBRAINZ_FORM_LOGIN_DISABLED",
    ...
    {
      id: "BIZBRAINZ_FORM_CALLOUT_BANNER",
      category: SettingCategories.FORM_AUTH,
      subCategory: SettingSubCategories.FORMLOGIN,
...
const GoogleAuth: AdminConfigType = {
  ...
  settings: [
    {
      id: "BIZBRAINZ_OAUTH2_GOOGLE_READ_MORE",
    ...
    {
      id: "BIZBRAINZ_OAUTH2_GOOGLE_CLIENT_ID",
      category: SettingCategories.GOOGLE_AUTH,
      subCategory: SettingSubCategories.GOOGLE,
    ...
    {
      id: "BIZBRAINZ_OAUTH2_GOOGLE_CLIENT_SECRET",
      category: SettingCategories.GOOGLE_AUTH,
      subCategory: SettingSubCategories.GOOGLE,
      controlType: SettingTypes.TEXTINPUT,
      controlSubType: SettingSubtype.TEXT,
    ...
    {
      id: "BIZBRAINZ_SIGNUP_ALLOWED_DOMAINS",
      category: SettingCategories.GOOGLE_AUTH,
      subCategory: SettingSubCategories.GOOGLE,
      controlType: SettingTypes.TEXTINPUT,
      controlSubType: SettingSubtype.TEXT,
...
const GithubAuth: AdminConfigType = {
  ...
  settings: [
    {
      id: "BIZBRAINZ_OAUTH2_GITHUB_READ_MORE",
    ...
    {
      id: "BIZBRAINZ_OAUTH2_GITHUB_CLIENT_ID",
      category: SettingCategories.GITHUB_AUTH,
      subCategory: SettingSubCategories.GITHUB,
      controlType: SettingTypes.TEXTINPUT,
      controlSubType: SettingSubtype.TEXT,
    ...
    {
      id: "BIZBRAINZ_OAUTH2_GITHUB_CLIENT_SECRET",
      category: SettingCategories.GITHUB_AUTH,
      subCategory: SettingSubCategories.GITHUB,
      controlType: SettingTypes.TEXTINPUT,
      controlSubType: SettingSubtype.TEXT,
