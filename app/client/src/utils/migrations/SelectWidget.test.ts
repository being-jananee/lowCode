...
describe("MigrateSelectTypeWidgetDefaultValue", () => {
  ...
  it("should check that its not touching the dsl tree structure", () => {
    const input = {
      ...
      children: [
        {
          boxShadow: "{{bizBrainz.theme.boxShadow.appBoxShadow}}",
          widgetName: "Table1",
          defaultPageSize: 0,
          ...
          primaryColumns: {
            ...
            action: {
              ...
              label: "action",
              onClick:
                "{{currentRow.step === '#1' ? showAlert('Done', 'success') : currentRow.step === '#2' ? navigateTo('https://docs.bizBrainz.com/core-concepts/connecting-to-data-sources/querying-a-database',undefined,'NEW_WINDOW') : navigateTo('https://docs.bizBrainz.com/core-concepts/displaying-data-read/display-data-tables',undefined,'NEW_WINDOW')}}",
              computedValue:
                '{{Table1.processedTableData.map((currentRow, currentIndex) => ( currentRow["action"]))}}',
              validation: {},
              labelColor: "#FFFFFF",
              buttonColor:
                "{{Table1.processedTableData.map((currentRow, currentIndex) => ( bizBrainz.theme.colors.primaryColor))}}",
              borderRadius:
                "{{Table1.processedTableData.map((currentRow, currentIndex) => ( bizBrainz.theme.borderRadius.appBorderRadius))}}",
              boxShadow:
          ...
          childStylesheet: {
            ...
            menuButton: {
              menuColor: "{{bizBrainz.theme.colors.primaryColor}}",
              borderRadius: "{{bizBrainz.theme.borderRadius.appBorderRadius}}",
              boxShadow: "none",
            },
            iconButton: {
            ...
            editActions: {
              saveButtonColor: "{{bizBrainz.theme.colors.primaryColor}}",
              saveBorderRadius:
                "{{bizBrainz.theme.borderRadius.appBorderRadius}}",
              discardButtonColor: "{{bizBrainz.theme.colors.primaryColor}}",
              discardBorderRadius:
                "{{bizBrainz.theme.borderRadius.appBorderRadius}}",
            },
          },
                      ...
                      children: [
                        {
                          ...
                          animateLoading: true,
                          overflow: "NONE",
                          fontFamily: "{{bizBrainz.theme.fontFamily.appFont}}",
                          leftColumn: 1.5,
                          dynamicBindingPathList: [
                            {
                              key: "fontFamily",
