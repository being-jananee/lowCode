  ...
  it("Get dependency chain", () => {
    ...
    const inverseDependencies: DependencyMap[] = [
      ...
      },
      {
        ...
        "bizBrainz.theme.colors": ["bizBrainz.theme"],
        "bizBrainz.theme.borderRadius": ["bizBrainz.theme"],
        "bizBrainz.theme.fontFamily": ["bizBrainz.theme"],
        "bizBrainz.theme.boxShadow": ["bizBrainz.theme"],
        "bizBrainz.theme": ["bizBrainz"],
