    ...
    const output = [
      {
        ...
        propertyValue:
          "{{Table1.sanitizedTableData.map((currentRow) => ( bizBrainz.theme.colors.primaryColor))}}",
      },
      {
      ...
      },
      {
        ...
        propertyValue:
          "{{Table1.sanitizedTableData.map((currentRow) => ( bizBrainz.theme.borderRadius.appBorderRadius))}}",
      },
      {
