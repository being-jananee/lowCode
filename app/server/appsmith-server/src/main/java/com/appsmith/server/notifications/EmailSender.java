package com.bizBrainz.server.notifications;
...
public class EmailSender {
    ...
    private InternetAddress makeReplyTo() {
        try {
            return new InternetAddress(this.emailConfig.getReplyTo(), "Bizbrainz");
        } catch (UnsupportedEncodingException e) {
            log.error("Encoding error creating Bizbrainz reply to address.", e);
            return null;
        }
    }
}
