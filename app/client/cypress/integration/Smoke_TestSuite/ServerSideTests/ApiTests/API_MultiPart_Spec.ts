...
describe("Validate API request body panel", () => {
  ...
  it("7. Checks MultiPart form data for a File Type upload + Bug 12476", () => {
    ...
    apiPage.CreateAndFillApi(
      "https://api.cloudinary.com/v1_1/bizBrainzautomationcloud/image/upload?upload_preset=fbbhg4xu",
      "CloudinaryUploadApi",
      30000, "POST"
    );
    ...
    cy.xpath(apiPage._imageSrc)
      ...
      .invoke("attr", "src")
      .then(($src) => {
        expect($src).not.eq("https://assets.bizBrainz.com/widgets/default.png");
      });
