...
public class LayoutServiceTest {
    ...
    public void updateLayoutInvalidPageId() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.ACL_NO_RESOURCE_FOUND
    ...
    public void testIncorrectDynamicBindingPathInDsl() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> {
                    assertThat(throwable).isInstanceOf(BizbrainzException.class);
                    assertThat(throwable.getMessage()).isEqualTo(
                            BizbrainzError.INVALID_DYNAMIC_BINDING_REFERENCE.getMessage("test_type", "testWidget", "id", "dynamicGet_IncorrectKey", pageId, layoutId.get(), null)
                    );
                    return true;
                })
                .verify();
