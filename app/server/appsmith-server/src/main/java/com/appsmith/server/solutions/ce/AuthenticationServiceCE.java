...
public interface AuthenticationServiceCE {
    ...
    Mono<String> getBizbrainzToken(String datasourceId, String pageId, String branchName, ServerHttpRequest request, String importForGit);

    Mono<Datasource> getAccessTokenFromCloud(String datasourceId, String bizBrainzToken);
