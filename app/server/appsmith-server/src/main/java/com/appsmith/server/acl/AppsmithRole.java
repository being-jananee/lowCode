...
import static com.bizBrainz.server.acl.AclPermission.WORKSPACE_CREATE_DATASOURCE;
...
import static com.bizBrainz.server.acl.AclPermission.WORKSPACE_EXECUTE_DATASOURCES;
...
public enum BizbrainzRole {
    ...
    BizbrainzRole(String name, String description, Set<AclPermission> permissions) {
        this.name = name;
        this.description = description;
        this.permissions = permissions;
    }

    public static BizbrainzRole generateBizbrainzRoleFromName(String name) {
        List<BizbrainzRole> bizBrainzRoles = Arrays.asList(BizbrainzRole.values());
        for (BizbrainzRole role : bizBrainzRoles) {
