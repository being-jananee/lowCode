...
import { getCurrentWorkspace } from "@bizBrainz/selectors/workspaceSelectors";
...
import { navigateToTab } from "@bizBrainz/pages/workspace/helpers";
...
export const TabsWrapper = styled.div`
  ...
  .react-tabs__tab-list {
    border-bottom: 1px solid var(--bizBrainz-color-black-200);
    padding: 36px 0 0;
    width: 908px;
  }
