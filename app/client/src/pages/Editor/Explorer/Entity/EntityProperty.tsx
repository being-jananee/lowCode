...
import { COPY_ELEMENT, createMessage } from "@bizBrainz/constants/messages";
...
const Wrapper = styled.div<{ step: number }>`
  &&&& {
    ...
    & {
      code.${SYNTAX_HIGHLIGHTING_SUPPORTED_LANGUAGES.BIZBRAINZ} {
        display: flex;
        white-space: nowrap;
      ...
      <CopyBox>
        <div className="flex flex-grow items-center">
          ...
          <StyledHighlightedCode
            ...
            codeText={codeText}
            language={SYNTAX_HIGHLIGHTING_SUPPORTED_LANGUAGES.BIZBRAINZ}
