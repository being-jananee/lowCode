...
public class WhereConditionUtils {
    ...
    public static Query applyWhereConditional(Query query, String strPath, String operatorString, String strValue) throws BizbrainzPluginException {
        ...
        if (query == null) {
            throw new BizbrainzPluginException(
                    ...
                    "Bizbrainz server has found null query object when applying where conditional on Firestore " +
                            "query. Please contact Bizbrainz's customer support to resolve this."
            );
        }
        ...
        try {
            ...
            throw new BizbrainzPluginException(
                    BizbrainzPluginError.PLUGIN_ERROR,
                    "Bizbrainz server has encountered an invalid operator for Firestore query's where conditional." +
                            " Please contact Bizbrainz's customer support to resolve this."
            );
        }
