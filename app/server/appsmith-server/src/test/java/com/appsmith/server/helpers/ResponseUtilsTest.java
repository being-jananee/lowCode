...
public class ResponseUtilsTest {
    ...
    public void getPage_withDefaultIdsPresent_returnsUpdatedPage() {
        ...
        BizbrainzBeanUtils.copyNestedNonNullProperties(newPage, newPageCopy);
    ...
    public void getAction_withDefaultIdsPresent_returnsUpdatedAction() {
        ...
        BizbrainzBeanUtils.copyNestedNonNullProperties(newAction, newActionCopy);
    ...
    public void getActionCollection_withDefaultIdsPresent_returnsUpdatedActionCollection() {
        ...
        BizbrainzBeanUtils.copyNestedNonNullProperties(actionCollection, actionCollectionCopy);
    ...
    public void getApplication_withDefaultIdsPresent_returnsUpdatedApplication() {
        ...
        BizbrainzBeanUtils.copyNestedNonNullProperties(application, applicationCopy);
