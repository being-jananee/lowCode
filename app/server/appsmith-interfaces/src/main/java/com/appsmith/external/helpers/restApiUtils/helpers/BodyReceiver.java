    ...
    static class OneValueConsumption<T> implements Subscriber<T> {
        ...
        public void onNext(T o) {
            if (remainedAccepts > 0) {
                ...
                throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_ERROR, "No more values can be consumed");
            }
        }

        @Override
        public void onError(Throwable t) {
            throw new BizbrainzPluginException(BizbrainzPluginError.PLUGIN_ERROR, "Single value was not consumed", t);
        }
