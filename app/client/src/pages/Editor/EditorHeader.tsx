...
import BizbrainzLogo from "assets/images/bizBrainz_logo_square.png";
...
} from "@bizBrainz/selectors/workspaceSelectors";
import { connect, useDispatch, useSelector } from "react-redux";
import DeployLinkButtonDialog from "components/designSystems/bizBrainz/header/DeployLinkButton";
...
import { retryPromise } from "utils/BizbrainzUtils";
...
const BizbrainzLink = styled((props) => {
...
export function EditorHeader(props: EditorHeaderProps) {
  ...
  return (
    <ThemeProvider theme={theme}>
      <HeaderWrapper className="pr-3" data-testid="t--bizBrainz-editor-header">
        <HeaderSection className="space-x-3">
          ...
          <TooltipComponent
            ...
            position="bottom-left"
          >
            <BizbrainzLink to={APPLICATIONS_URL}>
              <img
                alt="Bizbrainz logo"
                className="t--bizBrainz-logo"
                src={BizbrainzLogo}
              />
            </BizbrainzLink>
          </TooltipComponent>
