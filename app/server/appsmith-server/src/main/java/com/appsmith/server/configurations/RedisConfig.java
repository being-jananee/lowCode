...
import com.bizBrainz.server.domains.UserSession;
...
public class RedisConfig {
    ...
    @Bean
    ChannelTopic topic() {
        return new ChannelTopic("bizBrainz:queue");
    }
    ...
    private static class JSONSessionRedisSerializer implements RedisSerializer<Object> {
        ...
        private static final byte[] SESSION_DATA_PREFIX = "bizBrainz-session:".getBytes();
