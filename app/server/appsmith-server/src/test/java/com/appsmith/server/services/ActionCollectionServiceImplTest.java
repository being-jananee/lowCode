...
public class ActionCollectionServiceImplTest {
        ...
        StepVerifier.create(actionCollectionDTOMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage()
                                .equals(BizbrainzError.DUPLICATE_KEY_USER_ERROR
    ...
    public void testUpdateUnpublishedActionCollection_withInvalidId_throwsError() throws IOException {
        ...
        StepVerifier.create(actionCollectionDTOMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.NO_RESOURCE_FOUND.getMessage(FieldName.ACTION_COLLECTION, "testId")))
                .verify();
    }
    ...
    public void testDeleteUnpublishedActionCollection_withInvalidId_throwsError() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable
                                .getMessage()
                                .equals(BizbrainzError.NO_RESOURCE_FOUND.getMessage(FieldName.ACTION_COLLECTION, "invalidId")))
                .verify();
    }
    ...
    public void testRefactorCollectionName_withDuplicateName_throwsError() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(e -> BizbrainzError.DUPLICATE_KEY_USER_ERROR.getMessage("newName", FieldName.NAME).equals(e.getMessage()))
                .verify();
    }
