...
public class UserDataServiceTest {
    ...
    public void saveConfig_AuthorEmailNull_ThrowInvalidParameterError() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException
                        && throwable.getMessage().contains(BizbrainzError.INVALID_PARAMETER.getMessage("Author Email")))
                .verify();
    }
    ...
    public void saveConfig_AuthorNameEmptyString_ThrowInvalidParameterError() {
        GitProfile gitGlobalConfigDTO = createGitProfile("test@bizBrainz.com", null);
    ...
    public void getAndUpdateDefaultGitProfile_fallbackValueFromUserProfileIfEmpty_updateWithProfile() {
        ...
        GitProfile gitGlobalConfigDTO = createGitProfile("test@bizBrainz.com", "Test 1");
