...
import UserApi, { SendTestEmailPayload } from "@bizBrainz/api/UserApi";
...
export function* FetchAdminSettingsSaga() {
  ...
  if (isValidResponse) {
    const { appVersion, cloudHosting } = getBizbrainzConfigs();
    const settings = {
      //@ts-expect-error: response is of type unknown
      ...response.data,
      BIZBRAINZ_CURRENT_VERSION: createMessage(
        BIZBRAINZ_DISPLAY_VERSION,
        appVersion.edition,
        appVersion.id,
        cloudHosting,
