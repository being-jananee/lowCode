...
import BizbrainzLogo from "assets/images/bizBrainz_logo.png";
import {
...
import { SUPER_USER_SUBMIT_PATH } from "@bizBrainz/constants/ApiConstants";
...
const BizbrainzLogoImg = styled.img`
  max-width: 170px;
`;
...
function SetupForm(props: SetupFormProps) {
  ...
  return (
    <PageWrapper>
      <SetupFormContainer>
        <LogoContainer>
          <BizbrainzLogoImg alt="Bizbrainz logo" src={BizbrainzLogo} />
        </LogoContainer>
        <form
          action={signupURL}
