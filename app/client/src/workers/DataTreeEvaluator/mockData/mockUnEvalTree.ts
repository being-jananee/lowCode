...
export const unEvalTree = {
  ...
  bizBrainz: {
    ...
    URL: {
      fullPath:
        "https://dev.bizBrainz.com/applications/6200d1a2b5bfc0392b959cab/pages/6220c268c48234070f8ac65a/edit?a=b",
      host: "dev.bizBrainz.com",
      hostname: "dev.bizBrainz.com",
      queryParams: {
        a: "b",
      },
      protocol: "https:",
...
export const asyncTagUnevalTree: DataTree = {
  Api1: {
    ...
    data: {
      args: {},
      url: "https://mock-api.bizBrainz.com/echo/get",
      headers: {
        accept: "*/*",
  ...
  bizBrainz: ({
    ...
    URL: {
      fullPath:
        "https://app.bizBrainz.com/app/untitled-application-25/page1-6272179d8a368d6f1efcd0d2/edit",
      host: "app.bizBrainz.com",
      hostname: "app.bizBrainz.com",
      queryParams: {},
      protocol: "https:",
      pathname:
    ...
    mode: "EDIT",
    ENTITY_TYPE: ENTITY_TYPE.BIZBRAINZ,
  } as unknown) as DataTreeBizbrainz,
};
...
export const lintingUnEvalTree = {
  ...
  bizBrainz: {
    ...
    URL: {
      fullPath:
        "https://dev.bizBrainz.com/app/untitled-application-1/page1-62bf3730174c17103179d18c/edit",
      host: "dev.bizBrainz.com",
      hostname: "dev.bizBrainz.com",
      queryParams: {},
      protocol: "https:",
