...
# Variable - AMI naming
locals {
  ami_name   = "bizBrainz-ami-${local.timestamp}"
  image_name = "bizBrainz-marketplace-snapshot-${local.timestamp}"
}
...
build {
  ...
  provisioner "ansible" {
    ...
    user = "bizBrainz"
    playbook_file = "../ansible/bizBrainz_playbook/bizBrainz-playbook.yml"
  }
