...
public class AuthenticationServiceTest {
    ...
    public void testGetAuthorizationCodeURL_missingDatasource() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable ->
                        throwable instanceof BizbrainzException &&
                                ((BizbrainzException) throwable).getError().equals(BizbrainzError.NO_RESOURCE_FOUND) &&
    ...
    public void testGetAuthorizationCodeURL_invalidDatasourceWithNullAuthentication() {
        ...
        StepVerifier
                ...
                .expectErrorMatches(throwable ->
                        throwable instanceof BizbrainzException &&
                                ((BizbrainzException) throwable).getError().equals(BizbrainzError.INVALID_PARAMETER) &&
