  ...
  return (
    <Overlay hasBackdrop isOpen transitionDuration={25} usePortal>
      <Wrapper className="t--onboarding-introduction-modal">
        <CenteredContainer>
          <StyledClose
            className="t--how-bizBrainz-works-modal-close"
            color="#919397"
            icon="cross"
            iconSize={16}
            onClick={onBuildApp}
          />
          <ModalHeaderWrapper className="t--how-bizBrainz-works-modal-header">
            <ModalHeader>{createMessage(WELCOME_TO_BIZBRAINZ)}</ModalHeader>
            <ModalSubHeader>{createMessage(HOW_BIZBRAINZ_WORKS)}</ModalSubHeader>
          </ModalHeaderWrapper>
