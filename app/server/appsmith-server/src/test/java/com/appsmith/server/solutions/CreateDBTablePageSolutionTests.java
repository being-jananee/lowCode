...
import com.bizBrainz.external.models.DatasourceStructure.Key;
import com.bizBrainz.external.models.DatasourceStructure.Table;
import com.bizBrainz.external.models.DatasourceStructure.TableType;
...
public class CreateDBTablePageSolutionTests {
    ...
    public void createPageWithInvalidDatasourceTest() {
        ...
        StepVerifier
                .create(resultMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.INVALID_DATASOURCE.getMessage(FieldName.DATASOURCE, invalidDatasource.getId())))
                .verify();
    ...
    public void createPageWithInvalidRequestBodyTest() {
        ...
        StepVerifier
                .create(resultMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.INVALID_PARAMETER.getMessage("tableName and datasourceId")))
                .verify();
    }
    ...
    public void createPage_withInvalidBranchName_throwException() {
        ...
        StepVerifier
                .create(resultMono)
                .expectErrorMatches(throwable -> throwable instanceof BizbrainzException &&
                        throwable.getMessage().equals(BizbrainzError.NO_RESOURCE_FOUND.getMessage(FieldName.PAGE, pageId + ", " + "invalidBranch")))
                .verify();
    }
