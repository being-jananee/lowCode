...
import com.bizBrainz.server.domains.AbstractCommentDomain;
    ...
    public NewPage updateNewPageWithDefaultResources(NewPage newPage) {
        ...
        if (defaultResourceIds == null
            ...
            log.error(
                    ...
                    newPage.getId(),
                    new BizbrainzException(BizbrainzError.DEFAULT_RESOURCES_UNAVAILABLE, "page", newPage.getId())
            );
        ...
        for (PageNameIdDTO page : pageNameIdList) {
            if (StringUtils.isEmpty(page.getDefaultPageId())) {
                log.error(
                        ...
                        page.getId(),
                        new BizbrainzException(BizbrainzError.DEFAULT_RESOURCES_UNAVAILABLE, "applicationPage", page.getId())
                );
                continue;
            }
    ...
    public NewAction updateNewActionWithDefaultResources(NewAction newAction) {
        ...
        if (defaultResourceIds == null
            ...
            log.error(
                    ...
                    newAction.getId(),
                    new BizbrainzException(BizbrainzError.DEFAULT_RESOURCES_UNAVAILABLE, "newAction", newAction.getId())
            );
    ...
    public ActionCollection updateActionCollectionWithDefaultResources(ActionCollection actionCollection) {
        ...
        if (defaultResourceIds == null
            ...
            log.error(
                    ...
                    new BizbrainzException(BizbrainzError.DEFAULT_RESOURCES_UNAVAILABLE, "actionCollection", actionCollection.getId())
            );
