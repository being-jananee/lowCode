...
public class LayoutCollectionServiceCEImpl implements LayoutCollectionServiceCE {
    ...
    public Mono<ActionCollectionDTO> createCollection(ActionCollectionDTO collection) {
        ...
        if (!validationMessages.isEmpty()) {
            return Mono.error(new BizbrainzException(
                    BizbrainzError.INVALID_ACTION_COLLECTION,
                    collection.getName(),
        ...
        Mono<NewPage> pageMono = newPageService
                ...
                .switchIfEmpty(Mono.error(
                        new BizbrainzException(BizbrainzError.ACL_NO_RESOURCE_FOUND, FieldName.PAGE, pageId)))
                .cache();
        ...
        return pageMono
                ...
                .flatMap(tuple -> {
                    ...
                    BizbrainzBeanUtils.copyNewFieldValuesIntoOldObject(collection.getDefaultResources(), defaultDTOResource);
                    ...
                    BizbrainzBeanUtils.copyNewFieldValuesIntoOldObject(actionCollection.getDefaultResources(), defaults);
    ...
    public Mono<LayoutDTO> refactorAction(RefactorActionNameInCollectionDTO refactorActionNameInCollectionDTO) {
        ...
        Mono<ActionCollection> actionCollectionMono = actionCollectionService.findById(actionCollectionDTO.getId(), MANAGE_ACTIONS)
                .switchIfEmpty(Mono.error(new BizbrainzException(BizbrainzError.ACL_NO_RESOURCE_FOUND, FieldName.ACTION_COLLECTION, actionCollectionDTO.getId())));
