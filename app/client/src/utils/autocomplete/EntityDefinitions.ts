...
export const entityDefinitions = {
  BIZBRAINZ: (entity: DataTreeBizbrainz, extraDefsToDefine: ExtraDef) => {
    ...
    if (
      ...
      return {
        ...
        geolocation: {
          ...
          "!url":
            "https://docs.bizBrainz.com/v/v1.2.1/framework-reference/geolocation",
          getCurrentPosition:
  ...
  ACTION: (entity: DataTreeAction, extraDefsToDefine: ExtraDef) => {
    ...
    return {
      ...
      "!url": "https://docs.bizBrainz.com/v/v1.2.1/framework-reference/run",
      isLoading: "bool",
      data,
      responseMeta: {
  ...
  AUDIO_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/audio",
    playState: "number",
    autoPlay: "bool",
  },
  CONTAINER_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/container",
    backgroundColor: {
      "!type": "string",
      "!url": "https://docs.bizBrainz.com/widget-reference/container",
    },
  ...
  INPUT_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/input",
    text: {
      "!type": "string",
  ...
  TABLE_WIDGET: (widget: any, extraDefsToDefine?: ExtraDef) => ({
    "!doc":
      "The Table is the hero widget of Bizbrainz. You can display data from an API in a table, trigger an action when a user selects a row and even work with large paginated data sets",
    "!url": "https://docs.bizBrainz.com/widget-reference/table",
  ...
  VIDEO_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/video",
    playState: "number",
    autoPlay: "bool",
  },
  DROP_DOWN_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/dropdown",
    isVisible: isVisible,
    filterText: {
      "!type": "string",
  ...
  IMAGE_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/image",
    image: "string",
    isVisible: isVisible,
  },
  TEXT_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/text",
    isVisible: isVisible,
    text: "string",
  },
  BUTTON_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/button",
    isVisible: isVisible,
    text: "string",
    isDisabled: "bool",
  ...
  BUTTON_GROUP_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/button-group",
    isVisible: isVisible,
  },
  DATE_PICKER_WIDGET: {
    "!doc":
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/datepicker",
    isVisible: isVisible,
    selectedDate: "string",
    isDisabled: "bool",
  },
  ...
  CHECKBOX_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/checkbox",
    isVisible: isVisible,
    isChecked: "bool",
    isDisabled: "bool",
  },
  SWITCH_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/switch",
    isVisible: isVisible,
    isSwitchedOn: "bool",
    isDisabled: "bool",
  },
  RADIO_GROUP_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/radio",
    isVisible: isVisible,
    options: "[$__dropdownOption__$]",
  ...
  CHART_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/chart",
    isVisible: isVisible,
    chartData: {
      seriesName: "string",
  ...
  FORM_WIDGET: (widget: any, extraDefsToDefine?: ExtraDef) => ({
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/form",
    isVisible: isVisible,
  ...
  FILE_PICKER_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/filepicker",
    isVisible: isVisible,
    files: "[$__file__$]",
    isDisabled: "bool",
  },
  ...
  LIST_WIDGET: (widget: any, extraDefsToDefine?: ExtraDef) => ({
    "!doc":
      "Containers are used to group widgets together to form logical higher order widgets. Containers let you organize your page better and move all the widgets inside them together.",
    "!url": "https://docs.bizBrainz.com/widget-reference/list",
    backgroundColor: {
      "!type": "string",
      "!url": "https://docs.bizBrainz.com/widget-reference/how-to-use-widgets",
    },
    isVisible: isVisible,
    gridGap: "number",
  ...
  RATE_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/rate",
    isVisible: isVisible,
    value: "number",
    maxCount: "number",
  },
  IFRAME_WIDGET: (widget: any) => ({
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/iframe",
    isVisible: isVisible,
    source: "string",
    title: "string",
  ...
  DIVIDER_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/divider",
    isVisible: isVisible,
    orientation: "string",
    capType: "string",
    capSide: "number",
  ...
  MENU_BUTTON_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/menu-button",
    isVisible: isVisible,
    label: "string",
  },
  ...
  SINGLE_SELECT_TREE_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/treeselect",
    isVisible: isVisible,
    selectedOptionValue: {
      "!type": "string",
  ...
  ICON_BUTTON_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/icon-button",
    isVisible: isVisible,
  },
  CHECKBOX_GROUP_WIDGET: {
    "!doc":
      "Checkbox group widget allows users to easily configure multiple checkboxes together.",
    "!url": "https://docs.bizBrainz.com/widget-reference/checkbox-group",
    isVisible: isVisible,
    isDisabled: "bool",
    isValid: "bool",
    options: "[$__dropdownOption__$]",
  ...
  STATBOX_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/stat-box",
    isVisible: isVisible,
  },
  AUDIO_RECORDER_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/recorder",
    isVisible: isVisible,
    blobURL: "string",
    dataURL: "string",
    rawBinary: "string",
  ...
  PROGRESSBAR_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/progressbar",
    isVisible: isVisible,
    progress: "number",
  },
  SWITCH_GROUP_WIDGET: {
  ...
  MAP_CHART_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/map-chart",
    isVisible: isVisible,
    selectedDataPoint: {
      id: "string",
      label: "string",
  ...
  CURRENCY_INPUT_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/currency-input",
    text: {
      "!type": "string",
  ...
  PHONE_INPUT_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/phone-input",
    text: {
      "!type": "string",
      "!doc": "The text value of the input",
      "!url": "https://docs.bizBrainz.com/widget-reference/phone-input",
  ...
  CIRCULAR_PROGRESS_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/circular-progress",
    isVisible: isVisible,
    progress: "number",
  },
  JSON_FORM_WIDGET: (widget: any) => ({
    ...
    // TODO: Update the url
    "!url": "https://docs.bizBrainz.com/widget-reference",
  ...
  PROGRESS_WIDGET: {
    ...
    "!url": "https://docs.bizBrainz.com/widget-reference/progress",
    isVisible: isVisible,
    progress: "number",
  },
  DOCUMENT_VIEWER_WIDGET: {
    "!doc": "Document viewer widget is used to show documents on a page",
    "!url": "https://docs.bizBrainz.com/reference/widgets/document-viewer",
    isVisible: isVisible,
    docUrl: "string",
  },
  ...
  CODE_SCANNER_WIDGET: {
    "!doc": "Scan a Code",
    "!url": "https://docs.bizBrainz.com/reference/widgets/code-scanner",
    isVisible: isVisible,
    isDisabled: "bool",
    value: "string",
  },
...
export const GLOBAL_FUNCTIONS = {
  "!name": "DATA_TREE.BIZBRAINZ.FUNCTIONS",
  navigateTo: {
