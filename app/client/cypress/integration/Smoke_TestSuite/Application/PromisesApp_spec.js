...
describe("JSEditor tests", function() {
  ...
  it("Testing promises with resetWidget, storeValue action and API call", () => {
    ...
    cy.CreateAPI("TC1api");
    cy.enterDatasourceAndPath("https://mock-api.bizBrainz.com/", "users");
    cy.SaveAndRunAPI();
    jsEditor.CreateJSObject(
      `export default {
            ...
            .then(() => {
              ...
              return this.myFun2() 		//return a toast message
                .then(() => {
                  ...
                  showAlert(bizBrainz.store.selected) }) }) 		//return a second toast message
            .catch(() =>  {
        ...
        clearStore: async () => { //function to clear store values
          Object.keys(bizBrainz.store).forEach((eachKey) => {
