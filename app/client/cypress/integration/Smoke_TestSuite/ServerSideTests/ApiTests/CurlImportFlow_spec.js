...
describe("Test curl import flow", function() {
  it("Test curl import flow Run and Delete", function() {
    ...
    cy.get("textarea").type("curl -X GET https://mock-api.bizBrainz.com/users");
    cy.importCurl();
  ...
  it("Bug:15175 Creating new cURL import query from entity explorer crashes the app", function() {
    ...
    cy.get("textarea").type(
      'curl -d \'{"name":"morpheus","job":"leader"}\' -H Content-Type:application/json -X POST https://mock-api.bizBrainz.com/echo/post',
      {
        force: true,
