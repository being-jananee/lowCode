    ...
    const expectedNewSchemaItem = {
      ...
      children: {
        __array_item__: {
          ...
          position: -1,
          accentColor:
            "{{((sourceData, formData, fieldState) => (bizBrainz.theme.colors.primaryColor))(JSONForm1.sourceData, JSONForm1.formData, JSONForm1.fieldState)}}",
          borderRadius:
  ...
  it("returns valid stylesheet value", () => {
    ...
    const inputAndExpectedOutput = [
      ...
      [
        ...
        "{{((sourceData, formData, fieldState) => (bizBrainz.theme.borderRadius.appBorderRadius))(Form1.sourceData, Form1.formData, Form1.fieldState)}}",
      ],
      ["schema", ""],
    ];
