...
import com.bizBrainz.external.helpers.restApiUtils.helpers.RequestCaptureFilter;
...
import com.bizBrainz.external.models.ApiContentType;
...
import com.bizBrainz.external.plugins.BaseRestApiPluginExecutor;
...
import static com.bizBrainz.external.helpers.PluginUtils.setValueSafelyInPropertyList;
    ...
    public static class GraphQLPluginExecutor extends BaseRestApiPluginExecutor {
        ...
        public Mono<ActionExecutionResult> executeCommon(APIConnection apiConnection,
            ...
            try {
                ...
                errorResult.setBody(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR.getMessage(e));
            ...
            if (contentTypeError != null) {
                errorResult.setBody(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR.getMessage("Invalid value for Content-Type."));
                errorResult.setRequest(actionExecutionRequest);
                return Mono.just(errorResult);
            }
            ...
            if (httpMethod == null) {
                errorResult.setBody(BizbrainzPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR.getMessage("HTTPMethod must be set."));
                errorResult.setRequest(actionExecutionRequest);
                return Mono.just(errorResult);
            }
            ...
            if (HttpMethod.POST.equals(httpMethod)) {
                ...
                return Mono.error(
                        new BizbrainzPluginException(
                                ...
                                "Bizbrainz server has found an unexpected HTTP method configured with the GraphQL " +
