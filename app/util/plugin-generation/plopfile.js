        ...
        actions: function(data) {
            ...
            if (data.name) {
               ...
               actions.push(
                {
                    type: 'add',
                    path: '../../server/bizBrainz-plugins/{{camelCase name}}/src/main/java/com.external.plugins/{{pascalCase name}}.java',
               ...
               actions.push(
                {
                    type: 'add',
                    path: '../../server/bizBrainz-plugins/{{camelCase name}}/src/test/java/com.external.plugins/{{pascalCase name}}Test.java',
               ...
               actions.push(
                {
                    type: 'add',
                    path: '../../server/bizBrainz-plugins/{{pascalCase name}}/plugin.properties',
               ...
               actions.push(
                {
                    type: 'add',
                    path: '../../server/bizBrainz-plugins/{{pascalCase name}}/pom.xml',
               ...
               actions.push(
                {
                    type: 'add',
                    path: '../../server/bizBrainz-plugins/{{camelCase name}}/src/main/resources/editor.json',
               ...
               actions.push(
                {
                    type: 'add',
                    path: '../../server/bizBrainz-plugins/{{camelCase name}}/src/main/resources/form.json',
               ...
               actions.push(
                {
                    type: 'modify',
                    pattern :/<\/modules>\n<\/project>/,
                    path: '../../server/bizBrainz-plugins/pom.xml',
               ...
               actions.push(
                {
                    type: 'modify',
                    pattern :/}[\n]*$/,
                    path: '../../server/bizBrainz-server/src/main/java/com/bizBrainz/server/migrations/DatabaseChangelog.java',
